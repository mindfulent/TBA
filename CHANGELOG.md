...
### Added
- **SynthCraft** 0.1.8 — AI-powered music generation for Minecraft. Describe the genre, mood, and lyrics you want, and get a full original song in seconds. Listen privately or broadcast server-wide as a shared soundtrack replacing vanilla ambient music. Press `.` (period) to open the menu.
...
### Added
- **SynthCraft** 0.1.7 — Initial SynthCraft addition (superseded by 0.9.95)
